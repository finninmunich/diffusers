...
def inversion_forward_process(model, x0,
    ...
    for t in op:
        # idx = t_to_idx[int(t)]
        idx = num_inference_steps - t_to_idx[int(t)] - 1  # 991->99, 981->98, 971->97... 1->0
...
def inversion_reverse_process(model,
    ...
    xt = xT.expand(batch_size, -1, -1, -1) # start from x_64
    # zs contians [z1,z2,z3,...z64]
